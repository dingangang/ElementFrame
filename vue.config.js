  ...
  configureWebpack: {
    plugins: [
      ...
      new SpritesPlugin({
        // 目标小图标
        src: {
          cwd: path.resolve(__dirname, './public/static/images/icons'),
          glob: '*.png'
        },
        // 输出雪碧图文件及样式文件
        target: {
        ...
        customTemplates: {
          function_based_template: path.resolve(__dirname, './public/static/sprite_handlebars_template.handlebars')
        },
        // 样式文件中调用雪碧图地址写法
        apiOptions: {
